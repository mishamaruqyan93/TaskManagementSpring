...
import am.itspace.taskmanagementspring.security.CurrentUser;
import am.itspace.taskmanagementspring.service.TaskService;
...
public class TaskController {
    ...
    @GetMapping("/tasks")
    public String tasksPage(@RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size,
